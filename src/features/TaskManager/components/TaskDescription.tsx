const TaskDescription = () => {
  return (
    <div className="border h-[10.95rem] w-[45rem] rounded-lg mt-4 shadow bg-white overflow-hidden">
        ...
        <div className="ml-32">
          <p className="text-medium py-3">
            ...
            <span className="text-green-500">
              <i className="fa-solid fa-circle-check"></i> Yes
            </span>
          </p>
          <p className="text-medium py-1">
            Phone:{" "}
            <span>
              <i className="fa-solid fa-phone-volume"></i> 845-412-7892
            </span>
          </p>
          <p className="text-medium py-3">
            Priority:{" "}
            <span className="text-orange-300">
              <i className="fa-solid fa-circle-check"></i> Medium
            </span>
          </p>
        </div>
      </div>
