...
const DashboardHome = () => {
  ...
  const search = useSelector((state: RootState) => state.home.search);
  /* RENT */
  ...
  return (
    <div className="pt-3 max-w-[74.3rem] m-auto p-4 ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        />
        <div className="border shadow bg-white rounded-lg h-72 p-2">
        ...
        <div className="border shadow rounded-lg bg-white h-32 p-2 md:col-span-2">Cards</div>
