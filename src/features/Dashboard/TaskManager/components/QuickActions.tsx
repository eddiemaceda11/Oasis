...
const QuickActions = ({ postQuickActionUpdate, setPostQuickActionUpdate }: ModalProps) => {
  ...
  return (
    <div className="border h-36 min-w-[45rem] rounded-lg shadow bg-white overflow-hidden ">
      <p className="bg-slate-100 pl-4 font-medium py-1">Quick Actions</p>
      {!postQuickActionUpdate ? (
        <div>
        ...
        <div>
          ...
          <div className="flex items-center">
            <textarea
              ...
              className="ml-5 w-[36rem] h-12 pl-2 pt-1 break-words"
            ></textarea>
            <button
